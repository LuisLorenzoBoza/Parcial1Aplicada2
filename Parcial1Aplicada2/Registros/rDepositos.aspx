<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rDepositos.aspx.cs" Inherits="Parcial1Aplicada2.Registros.rEmisores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-7">
            <label for="TextBoxMonto">Cartas</label>
            <asp:TextBox TextMode="Number" class="form-control" ID="TextBoxCartas" runat="server" placeholder="Cartas"></asp:TextBox>
        </div>
        <asp:RequiredFieldValidator ForeColor="red" ID="RequiredFieldValidator3" runat="server" Display="Dynamic" ControlToValidate="TextBoxMonto" Font-Bold="True" ErrorMessage="No puede dejar cartas vacio"></asp:RequiredFieldValidator>
    </div>
